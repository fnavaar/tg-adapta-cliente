...
|---|---|---|---|
| 2026-08-31 | Champion (João Paulo) | CA-1-07 · RN-F1-008 | EMENDA APROVADA: Suspect é estado de entrada — pode existir sem responsável, próxima ação e prazo enquanto não distribuído. A partir de Prospect (não terminal), responsável + próxima ação + prazo são obrigatórios. Texto original preservado no corpo da SPEC; emenda registrada aqui (append-only). |

| 2026-09-01 | Champion (João Paulo) | F1-T05 · CA-1-08 · CA-1-10 | EMENDA APROVADA: Handoff é a distribuição interna do registro para comercial/GN entre Suspect e Prospect. Suspect representa registro/empresa ainda não assumido para trabalho comercial; Prospect representa registro cujo handoff foi aceito pelo comercial/GN. Suspect→Prospect exige handoff_status=aceito, responsavel, proxima_acao e prazo. handoff_status vazio significa nenhuma tentativa; pendente, tentativa realizada aguardando aceite; aceito, GN/comercial assumiu; recusado, GN/comercial não aceitou. Handoff recusado mantém Suspect e exige motivo, evidência, responsável e pendência. Retry exclusivamente manual com nova evidência; não existe histórico estruturado de múltiplos retries nesta fase, handoff_status representa a situação atual e evidencia registra provisoriamente as tentativas. icp_validado é validação HUMANA da GN: vazio = ainda não analisado; sim = dentro do ICP aprovado; nao = fora do ICP. O sistema não infere ICP. Prospect→Lead Qualificado exige icp_validado=sim, evidência de necessidade/problema/projeto/interesse real, contato profissional válido e oferta_servico identificada. icp_validado vazio ou nao impede Lead Qualificado; nao não gera automaticamente desqualificação ou outro estado terminal. Canal indisponível não é sinônimo de handoff recusado e permanece NÃO DEMONSTRÁVEL TECNICAMENTE nesta fase, sem campo, estado, simulação ou integração. |