...
- A divergência documental de numeração entre esta tabela/matriz e a SPEC F2-002 permanece aberta e não foi corrigida unilateralmente.
- A pendência arquitetural de identidade/multi-fonte permanece para tasks posteriores.
- A F2-T04 permanece pendente e não foi iniciada.
