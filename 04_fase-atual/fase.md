...
| F2-T05 | 5 | Materializar o registro de decisão e a fila de próxima ação para um experimento já reconciliado. | Direção/marketing | F2-003 | RN-F2-008, RN-F2-010 | Dados e integrações; Fluxo e regras; Checklist | Criar estrutura `DEC-F2-###` ligada a briefing, período, evidência, decisão, owner e próxima ação. | Captura/export do registro e permissões de decisão. | F2-T04 aceita; decisor identificado; critério de decisão definido no briefing. | Parar se exigir decisão automática, meta inferida, mudança de orçamento ou publicação. | AUTORIZADA — decisor: João Paulo (Champion/direção), confirmado em 2026-09-17; critério de decisão conforme briefing de cada experimento (RN-F2-008); execução única task ativa |
