...
| Fase 2; C-02/C-04; DC-007 | F2-003 | CA-2-07..09 | F2-T05, F2-T06 | Decisão humana e histórico de versões | F2-T05 concluída e validada (3/3 testes humanos em 18/09 + reteste GREEN aprovado em 21/09 pós-correção do detector; rollback DEC-F2-004→DEC-F2-002 provado); F2-T06 elegível, aguarda autorização expressa |
| Fase 2; DC-003; G-009 | F2-004 | CA-2-10..12 | F2-T07, F2-T08 | Checklist, fallback, falhas simuladas | F2-T07 elegível (aguarda sua vez — uma task por vez); F2-T08 bloqueada por dependência |
...
- F2-T05 concluída com decisor registrado (João Paulo, Champion/direção); o critério de decisão segue a RN-F2-008 — na prova sintética, o briefing sintético; decisão real continua exigindo critério real.
- `DEC-F2-003` permanece na massa sintética como registro criado pelo botão genérico durante o teste, sem vínculo com a cadeia de rollback — preservado por transparência, sem exclusão.
